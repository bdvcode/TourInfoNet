	...
	<div class="mp_hello">
		...
		<?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"CHECK_DATES" => "Y",
				"FIELD_CODE" => array(),
				"PROPERTY_CODE" => array("desc_pl", "header_pl"),
				"IBLOCK_URL" => "",
				"META_KEYWORDS" => "-",
				"META_DESCRIPTION" => "-",
				"BROWSER_TITLE" => "-",
...
<div data-index="2" class="first_fltr_pane map_pane">
	...
	<div class="ip_ff_header">
		...
		<h1><? $ee = CIBlockElement::GetProperty(15, 410, "sort", "asc", Array("CODE"=>"header_pl"));if($ee = $ee->Fetch()):echo ($ee["VALUE"]); endif;?></h1>
		<? $ee = CIBlockElement::GetProperty(15, 410, "sort", "asc", Array("CODE"=>"desc_pl"));if($ee = $ee->Fetch()):echo htmlspecialcharsBack($ee["VALUE"]["TEXT"]); endif;?>
	</div>
	...
	<div class="ip_ff_subcat_wrap">
		...
		<?$APPLICATION->IncludeComponent(
			...
			Array(
				"AREA_FILE_SHOW" => "file",
				"PATH" => SITE_DIR."include/city_country_pl.php",
				"EDIT_TEMPLATE" => ""
			)
		);?>
		...
		while($ob = $res->GetNextElement()):?>
			...
			<div class="ip_ff_subcat checkbox map_f1" data-price="<?echo($arFields['ID']);?>"><?echo($arFields['PROPERTY_NAME_PL_VALUE']);?></div>
		...
		while($ob = $res->GetNextElement()):?>
			<?$arFields = $ob->GetFields();?>
			<div class="ip_ff_subcat checkbox map_f1" data-type="<?echo($arFields['ID']);?>"><?echo($arFields['PROPERTY_NAME_PL_VALUE']);?></div>
		<?endwhile;?>
...
<div data-index="3" class="first_fltr_pane map_pane"> <!-- what-to-see -->
	...
	<div class="ip_ff_header">
		...
		<h1><? $ee = CIBlockElement::GetProperty(15, 411, "sort", "asc", Array("CODE"=>"header_pl"));if($ee = $ee->Fetch()):echo ($ee["VALUE"]); endif;?></h1>
		<? $ee = CIBlockElement::GetProperty(15, 411, "sort", "asc", Array("CODE"=>"desc_pl"));if($ee = $ee->Fetch()):echo htmlspecialcharsBack($ee["VALUE"]["TEXT"]); endif;?>
	</div>
	...
	<div class="ip_ff_subcat_wrap">
		...
		while(current($arr_fl)):?>
			...
			if($ar_res = $res->GetNext()):?>
				...
				<div class="ip_ff_subcat checkbox map_f1" data-type="<?echo($ar_res['ID']);?>"><?echo($arFields['PROPERTY_NAME_PL_VALUE']);?></div>
			<?endif;?>
		<?endwhile;?>
...
<div data-index="4" class="first_fltr_pane">
	...
	<div class="ip_ff_header">
		...
		<h1><? $ee = CIBlockElement::GetProperty(15, 408, "sort", "asc", Array("CODE"=>"header_pl"));if($ee = $ee->Fetch()):echo ($ee["VALUE"]); endif;?></h1>
		<? $ee = CIBlockElement::GetProperty(15, 408, "sort", "asc", Array("CODE"=>"desc_pl"));if($ee = $ee->Fetch()):echo htmlspecialcharsBack($ee["VALUE"]["TEXT"]); endif;?>
	</div>
...
<div data-index="5" class="first_fltr_pane map_pane">
	...
	<div class="ip_ff_header">
		...
		<h1><? $ee = CIBlockElement::GetProperty(15, 412, "sort", "asc", Array("CODE"=>"header_pl"));if($ee = $ee->Fetch()):echo ($ee["VALUE"]); endif;?></h1>
		<? $ee = CIBlockElement::GetProperty(15, 412, "sort", "asc", Array("CODE"=>"desc_pl"));if($ee = $ee->Fetch()):echo htmlspecialcharsBack($ee["VALUE"]["TEXT"]); endif;?>
	</div>
...
<div data-index="6" class="first_fltr_pane guided_pane">
	...
	<div class="ip_ff_header">
		...
		<h1><? $ee = CIBlockElement::GetProperty(15, 413, "sort", "asc", Array("CODE"=>"header_pl"));if($ee = $ee->Fetch()):echo ($ee["VALUE"]); endif;?></h1>
		<? $ee = CIBlockElement::GetProperty(15, 413, "sort", "asc", Array("CODE"=>"desc_pl"));if($ee = $ee->Fetch()):echo htmlspecialcharsBack($ee["VALUE"]["TEXT"]); endif;?>
	</div>
