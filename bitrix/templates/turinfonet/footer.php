...
<div id="mpContent">
	...
	<?if($urlLang == "en"):?>
		...
		<?if($urlLang == "ru"):?>
			...
			<div class="mp_selCat_in">
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-info_g"></b></i></div><h3>Важная<br/>информация</h3><div class="mp_selCat_item_lnk" data-link="/useful-info/"></div></div>
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-hotel_g"></b></i></div><h3>Где остановиться</h3><div class="mp_selCat_item_lnk" data-link="/where-to-stay/"></div></div>
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-attractions_g"></b></i></div><h3>Что посмотреть</h3><div class="mp_selCat_item_lnk" data-link="/what-to-see/"></div></div>
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-auto_g"></b></i></div><h3>Как добраться</h3><div class="mp_selCat_item_lnk" data-link="/transport/"></div></div>
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-food_g"></b></i></div><h3>Где поесть</h3><div class="mp_selCat_item_lnk" data-link="/where-to-eat/"></div></div>
				<div class="mp_selCat_item"><div class="table"><i><b class="sprite-excours_g"></b></i></div><h3>Экскурсии</h3><div class="mp_selCat_item_lnk" data-link="/guided-tours/"></div></div>
				<div class="clr"></div>
			</div>
