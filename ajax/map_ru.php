...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array("category","type","country","city","price","detail_text_lt","detail_text_pl","detail_text_en","contacts_lt","contacts_pl","contacts_en","adrr_ru","Web","tel","email","contacts"),
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "",
